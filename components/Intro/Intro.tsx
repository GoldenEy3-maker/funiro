...
const Intro = () => {
  ...
  const [startPosition, setStartPosition] = useState((slideWidth + gapSlides) / 3)
  ...
  const prevSlideHandler = () => {
    ...
    if (activeSlideIndex === 0) {
      setTransformX(
        (startPosition + (slideWidth + gapSlides)) +
        ...
        >
          <li className={ introSliderItem }>
            <Image
              ...
              //     .height
              // }
              width={ adaptiveValue(305, sliderDataRef.current[sliderDataRef.current.length - 2].image
                .width) }
              height={ adaptiveValue(305, sliderDataRef.current[sliderDataRef.current.length - 2].image
                .height) }
              layout="fixed"
              objectFit="cover"
            />
          ...
          <li className={ introSliderItem }>
            <Image
              ...
              alt=""
              width={ adaptiveValue(305, sliderDataRef.current[sliderDataRef.current.length - 1].image
                .width) }
              height={ adaptiveValue(305, sliderDataRef.current[sliderDataRef.current.length - 1].image
                .height) }
              // width={
              //   sliderDataRef.current[sliderDataRef.current.length - 1].image
              //     .width
